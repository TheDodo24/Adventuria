...
public class ScoreboardManager {
    ...
    public void sendScoreboard(Player player, int onlineSize) {
        ...
        PacketPlayOutScoreboardScore s6 = new PacketPlayOutScoreboardScore(ScoreboardServer.Action.CHANGE, "obj", "§8§l▰§7▰ §bGeld", 4);
        ...
        if(user.isCustomScoreboard()) {
            if(user.checkCustomScoreboard(CustomScoreboardType.CORP) && user.checkCustomScoreboard(CustomScoreboardType.BANK)) {
                ...
                s3 = new PacketPlayOutScoreboardScore(ScoreboardServer.Action.CHANGE, "obj", "§8§l▰§7▰ §aOnline", 13);
                ...
                s6 = new PacketPlayOutScoreboardScore(ScoreboardServer.Action.CHANGE, "obj", "§8§l▰§7▰ §bGeld", 10);
                ...
                if(Common.getInstance().getManager().getMySQL().checkCorp(user.getCustomScoreboard(CustomScoreboardType.CORP))) {
                    c2 = new PacketPlayOutScoreboardScore(ScoreboardServer.Action.CHANGE, "obj", "§8§l▰§7▰ §9Firma", 7);
                ...
                s3 = new PacketPlayOutScoreboardScore(ScoreboardServer.Action.CHANGE, "obj", "§8§l▰§7▰ §aOnline", 10);
                ...
                s6 = new PacketPlayOutScoreboardScore(ScoreboardServer.Action.CHANGE, "obj", "§8§l▰§7▰ §bGeld", 7);
                ...
                if(user.checkCustomScoreboard(CustomScoreboardType.CORP)) {
                    c2 = new PacketPlayOutScoreboardScore(ScoreboardServer.Action.CHANGE, "obj", "§8§l▰§7▰ §9Firma", 4);
