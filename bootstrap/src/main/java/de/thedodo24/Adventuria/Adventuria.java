...
public class Adventuria extends JavaPlugin {
    ...
    public void onEnable() {
            ...
            moduleManager.loadModules(Common.class, Economy.class, Utils.class, Towny.class);
        Bukkit.getScheduler().scheduleAsyncDelayedTask(this, () -> moduleManager.loadModule(Jail.class), 2L);
    }
